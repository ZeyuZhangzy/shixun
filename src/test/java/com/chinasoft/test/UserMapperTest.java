...
//	}
	...
	//动态插入sql——if
	@Test
	public void addUserWith_if() {
		SqlSession session = factory.openSession();
		UserMapper mapper = session.getMapper(UserMapper.class);
		User user = new User(30, "黎明明", "liming111", "6666666", "台湾新竹", "723872387@qq.com", 1);
		mapper.addUserWith_if(user);
		session.commit();
		session.close();
	}
	...
	public static void main(String[] args) {
		...
		new UserMapperTest().addUserWith_if();
	}
